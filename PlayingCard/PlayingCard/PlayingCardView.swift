...
class PlayingCardView: UIView {
    ...
    // * 0.80 cause card faces are different than in the example
    var faceCardScale: CGFloat = SizeRatio.faceCardImageSizeToBoundsSize * 0.80 { didSet { setNeedsDisplay() } }
    ...
    private func drawPips() {
        ...
        func createPipString(thatFits pipRect: CGRect) -> NSAttributedString {
            ...
            } else { return probablyOkayPipString }
        }
